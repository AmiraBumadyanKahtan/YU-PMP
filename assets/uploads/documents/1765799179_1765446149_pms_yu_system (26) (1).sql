...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2025 at 08:52 PM
...
(3, 3, 3, 6, 'in_progress', 5, '2025-12-07 11:48:15', '2025-12-10 08:53:59'),
...
(1, 1, 1, 'system_role', 13, NULL, 'Strategy Staff Review', 0),
(2, 1, 2, 'system_role', 11, NULL, 'Strategy Office Head Review', 0),
(3, 1, 3, 'system_role', 10, NULL, 'CEO Final Approval', 1),
...
(2, 'project', 5, 5, 'بلبالا', 1, 1, NULL, NULL, NULL, NULL, '2025-12-10 18:34:25', '2025-12-10 18:34:25'),
(3, 'project', 5, 5, 'همنمتنتن', 3, 1, NULL, NULL, NULL, NULL, '2025-12-10 18:37:32', '2025-12-10 18:37:32'),
(4, 'project', 5, 5, 'hghghfgh', 3, 1, NULL, NULL, NULL, NULL, '2025-12-10 19:03:13', '2025-12-10 19:03:13');
...
INSERT INTO `operational_projects` (`id`, `project_code`, `name`, `description`, `department_id`, `manager_id`, `initiative_id`, `budget_min`, `budget_max`, `approved_budget`, `spent_budget`, `start_date`, `end_date`, `status_id`, `progress_percentage`, `priority`, `visibility`, `created_at`, `updated_at`, `update_frequency`, `update_time`, `is_deleted`, `deleted_at`) VALUES
(1, 'OP-2025-0001', 'Test2', 'Test2 Test2', 1, 1, NULL, 10000.00, 20000.00, NULL, 0.00, '2025-12-16', '2026-01-08', 2, 0, 'high', 'private', '2025-12-07 07:58:27', '2025-12-07 12:37:31', 'every_2_days', '09:00:00', 1, '2025-12-07 15:37:31'),
(2, 'OP-2025-0002', 'Test255', 'Test255Test255', 1, 10, NULL, 15000.00, 25000.00, NULL, 0.00, '2025-12-10', '2026-01-10', 2, 0, 'high', 'private', '2025-12-07 11:20:33', '2025-12-07 11:23:07', 'every_2_days', '09:00:00', 0, NULL),
(3, 'OP-2025-0003', 'Test265', 'Test265Test265', 1, 10, NULL, 20000.00, 40000.00, NULL, 0.00, '2025-12-11', '2026-01-10', 3, 0, 'medium', 'private', '2025-12-07 11:47:05', '2025-12-10 05:47:01', 'every_2_days', '09:00:00', 0, NULL),
(4, 'OP-2025-0004', 'Test2552', 'Test2552', 2, 15, NULL, 10000.00, 20000.00, 15000.00, 0.00, '2025-12-11', '2026-01-10', 5, 0, 'medium', 'private', '2025-12-09 10:30:16', '2025-12-10 12:11:01', 'every_2_days', '09:00:00', 0, NULL),
(5, 'OP-2025-0005', 'Test5', 'Test5Test5', 1, 3, NULL, 15000.00, 30000.00, 25000.00, 0.00, '2025-12-11', '2026-01-10', 5, 0, 'medium', 'public', '2025-12-09 18:34:44', '2025-12-09 19:58:23', 'every_2_days', '09:00:00', 0, NULL);
...
(1, 5, 'Sustainable Investment Growth', 'Focus on diversifying revenue streams and achieving financial sustainability through strategic partnerships and environmental initiatives.', 1, 0.00, '2025-11-08', '2025-12-31', 11, 0, '#ff8c00', 'fa-building', '2025-11-28 08:02:38', '2025-12-03 09:42:20', 0, NULL),
(3, 1, 'Test1', 'Test1', 1, 0.00, '2025-12-02', '2025-12-17', 9, 0, '#12e2d5', 'fa-pencil', '2025-12-01 10:18:10', '2025-12-03 07:20:18', 0, NULL),
(8, 2, 'Test2', 'Test2', 3, 0.00, '2025-12-05', '2025-12-12', 9, 0, '#004cff', 'fa-building', '2025-12-03 12:38:48', '2025-12-03 12:43:34', 0, NULL),
...
(10, 6, 'Test6', 'Test6', 7, 0.00, '2025-12-17', '2026-01-01', 12, 0, '#ff0059', 'fa-sliders', '2025-12-04 10:05:40', '2025-12-04 10:05:40', 0, NULL),
(11, 7, 'Test7', 'Test7', 1, 0.00, '2025-12-18', '2026-01-07', 12, 0, '#ff0000', 'fa-coins', '2025-12-04 10:13:15', '2025-12-04 10:13:15', 0, NULL);
...
(1, 1, 5, '2025-12-09', 'every_2_days', 1, '2025-12-07 07:58:27'),
(2, 2, 10, '2025-12-09', 'every_2_days', 1, '2025-12-07 11:20:33'),
(3, 3, 10, '2025-12-09', 'every_2_days', 1, '2025-12-07 11:47:05');
...
(1, 'amira.kahtan', 'a_bumadyan@yu.edu.sa', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Amira Bumadyan', 'أميرة بومدين', 1, 1, '0558906017', 'Software Devlpoer', 'user_1_1764450223.jpg', 1, '2025-12-10 22:49:08', '2025-11-27 11:17:35', '2025-12-10 19:49:08', NULL, NULL, 0, NULL),
(3, 'kahtan', 'kahtan@interlink.edu', '$2y$10$rrlJ92b/e.nK/8roRjD3tOdHylS7kESE9xJmEklbeu5mSE4KC3hmS', 'Bu-Madyan Kahtan', NULL, 11, NULL, '0552468325', 'Executive Director', NULL, 1, '2025-12-10 22:12:07', '2025-11-30 08:18:15', '2025-12-10 19:12:07', NULL, NULL, 0, NULL),
(4, 'ceo', 'ceo@yu.edu.sa', '$2y$10$Aa00vZjcUVOpNKHqK7IKruN..9Y2Vku3wWqBPe0s7ko8bfwqrwAPa', 'ceo', NULL, 10, NULL, '0558906018', 'Chief Executive Officer', NULL, 1, '2025-12-10 15:05:51', '2025-12-03 09:45:37', '2025-12-10 12:05:51', NULL, NULL, 0, NULL),
(5, 'DepartmentManager', 'DepartmentManager@yu.edu.sa', '$2y$10$9ycV5HvoE7eA7TsgCQqjXutii.l2BSbhP76w6x2uXsz/hu170QSYS', 'Department Manager', NULL, 12, 1, '0558906019', 'Department Manager', NULL, 1, '2025-12-09 22:48:14', '2025-12-03 09:46:25', '2025-12-09 19:48:14', NULL, NULL, 0, NULL),
...
(7, 'StrategyStaff', 'StrategyStaff@yu.edu.sa', '$2y$10$CivrgRB2kgrHy/ab1/eOremC2L0beeQlz.brA7VkWSaaWMIgLQLla', 'Strategy Staff', NULL, 13, NULL, '0558906012', 'Strategy Staff', NULL, 1, '2025-12-04 14:38:07', '2025-12-03 09:47:38', '2025-12-08 05:24:00', NULL, NULL, 0, NULL),
(8, 'AhamedMohammed', 'AhamedMohammed@gmail.com', '$2y$10$YZU8jVfQ.bWQPQtqicXxbOO5DC.DOkkxrifZKnpkel/YAVtM18p8e', 'Ahamed Mohammed', NULL, 12, 1, '0558906078', 'Employee', NULL, 1, '2025-12-10 21:32:23', '2025-12-07 08:01:11', '2025-12-10 18:32:23', NULL, NULL, 0, NULL),
(10, 'test', 'test@gmail.com', '$2y$10$ZUbS.foqqQKtRyRu3QW2xeymEWcqDIE0iJIN5RlOiSwkTdxIjLmCa', 'Employee Test', NULL, 12, 2, '0558906125', 'Software Devlpoer', NULL, 1, '2025-12-10 22:18:23', '2025-12-07 11:18:59', '2025-12-10 19:18:23', NULL, NULL, 0, NULL),
(11, 'Ali', 'Ali@yu.edu.sa', '$2y$10$NGIK/G6xhFHvW/vPjYzB8eLeXcQYZ7HKOmUpY11N.IU4SerJYqUDa', 'Ali Ahmed', NULL, 14, 5, '0558906587', 'Finance Head', NULL, 1, '2025-12-10 22:43:52', '2025-12-07 11:52:16', '2025-12-10 19:43:52', NULL, NULL, 0, NULL),
(12, 'Mohammed', 'Mohammed@yu.edu.sa', '$2y$10$rZ7SrJ6hBvTpU/J5FJBDFu/nBoKTsYHpeVeDeBZdfWMTbLcvR4wHO', 'Mohammed Adam', NULL, 12, 1, '0578404042', 'Software Devlpoer', NULL, 1, '2025-12-09 21:37:31', '2025-12-09 06:21:02', '2025-12-09 18:58:33', NULL, NULL, 0, NULL),
...
(14, 'asmaa', 'asmaa@yu.edu.sa', '$2y$10$Yn/WJ/yTHxI5fy6S/Yi/A.J5XbMg8lORo38o4heBmScXirA6du4hK', 'Asmaa Ali', NULL, 6, 1, '0578404448', 'Employee', NULL, 1, NULL, '2025-12-09 06:43:33', '2025-12-09 06:48:28', NULL, NULL, 1, '2025-12-09 09:48:28'),
(15, 'khaled', 'khaled@gmail.com', '$2y$10$7NyBapRpECu8aSGMQzHL4uEz4JrMZZ2dW0/2rLaN0mlxzVQETnavy', 'Khaled Mohammed', NULL, 8, 1, '0578404478', 'Employee', NULL, 1, '2025-12-10 15:11:08', '2025-12-10 12:10:38', '2025-12-10 12:11:08', NULL, NULL, 0, NULL);
...
(1, 3, 'Review pillar #2', 'Review pillar \"Test2\" and record your decision.', NULL, 1, 0, 'pillar', 8, '2025-12-03 12:43:34'),
(2, 3, 'Review pillar #3', 'Review pillar \"Test3\" and record your decision.', NULL, 1, 0, 'pillar', 9, '2025-12-04 05:47:33'),
...
(4, 3, 'Review pillar #3', 'Review pillar \"Test3\" and record your decision.', NULL, 1, 0, 'pillar', 9, '2025-12-04 05:49:14'),
...
(15, 10, 'Approval Pending: Test265', 'Action required for stage: Department Head Approval', '2025-12-12 00:00:00', 1, 0, 'project', 3, '2025-12-10 05:08:29'),
...
(19, 10, 'Approval Pending: Test265', 'Action required for stage: Department Head Approval', '2025-12-12 00:00:00', 1, 0, 'project', 3, '2025-12-10 05:09:41'),
...
(26, 11, 'Collaboration Request', 'Project \'Test5\' needs resource from your department.', NULL, 1, 0, 'collaboration', 2, '2025-12-10 18:34:25'),
(27, 11, 'Collaboration Request', 'Project \'Test5\' needs resource from your department.', NULL, 1, 0, 'collaboration', 3, '2025-12-10 18:37:32'),
(28, 11, 'Collaboration Request', 'Project \'Test5\' needs resource from your department.', NULL, 1, 0, 'collaboration', 4, '2025-12-10 19:03:13');
...
--
-- Indexes for table `project_role_permissions`
--
ALTER TABLE `project_role_permissions`
  ADD PRIMARY KEY (`role_id`,`permission_id`),
  ADD KEY `idx_prp_perm` (`permission_id`);
...
--
-- Constraints for table `project_role_permissions`
--
ALTER TABLE `project_role_permissions`
  ADD CONSTRAINT `fk_prp_perm` FOREIGN KEY (`permission_id`) REFERENCES `permissions` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_prp_role` FOREIGN KEY (`role_id`) REFERENCES `project_roles` (`id`) ON DELETE CASCADE;
